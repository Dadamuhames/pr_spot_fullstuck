...
import admins.models.base_models
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.JSONField(blank=True, null=True, validators=[admins.models.base_models.json_field_validate], verbose_name='Заголовок сайта')),
                ('subtitle', models.JSONField(blank=True, null=True, verbose_name='Подзаголовок сайта')),
                ('description', models.JSONField(blank=True, null=True, verbose_name='Описание сайта')),
